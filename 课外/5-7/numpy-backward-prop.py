...
class NeuralNetwork:
    ...
    def train(self, X_train, X_test, y_train, y_test, learning_rate, max_epochs):
        ...
        mses = []
        accuracys = []
        for i in range(max_epochs + 1):  # 训练1000个epoch
...
def main():
    ...
    nn.add_layer(Layer(2, 25, 'sigmoid'))  # 隐藏层1
    nn.add_layer(Layer(25, 50, 'sigmoid'))  # 隐藏层2
    nn.add_layer(Layer(50, 25, 'sigmoid'))  # 隐藏层3
    nn.add_layer(Layer(25, 2, 'sigmoid'))  # 输出层
